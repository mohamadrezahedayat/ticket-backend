...
showSchema.virtual('events', {
  //to add virtual property events
  ref: 'Event', // in Event model
  foreignField: 'show', // in property show
  localField: '_id' //connsects to _id field of this (show) model
});
